...
## 安装
~~~
composer require Czthinkwechat/think-wechat 
~~~
...
#### 使用facade
```php
use Czthinkwechat\ThinkWechat\Facade;
...
```php
\think\facade\Route::rule('user','usere')->middleware(\Czthinkwechat\ThinkWechat\Middleware\OauthMiddleware::class);
```
